...
function get_picto($id) {
//webcal_entry_user.cal_id, webcal_entry_user.cal_category
	$res = dbi_query ('SELECT webcal_categories.cat_picto FROM webcal_categories LEFT JOIN webcal_entry_user ON webcal_entry_user.cal_category=webcal_categories.cat_id WHERE webcal_entry_user.cal_id='.$id);
	if ( $res ) {
