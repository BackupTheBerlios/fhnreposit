...
function activity_log ( $event_id, $user, $user_cal, $type, $text ) {
  ...
  if ( ! dbi_query ( $sql, true,true,"fct activity_log" ) ) {
...
//webcal_entry_user.cal_id, webcal_entry_user.cal_category
	$res = dbi_query ('SELECT webcal_ca_tegories.cat_picto FROM webcal_categories LEFT JOIN webcal_entry_user ON webcal_entry_user.cal_category=webcal_categories.cat_id WHERE webcal_entry_user.cal_id='.$id,true,true,"fct get_picto ");
	if ( $res ) {
