...
{
	echo "<a title=\"" . translate("Generate printer-friendly version") . "\" class=\"printer\" href=\"#\" onClick=\"popup('view_m.php?id=$id&amp;date=$thisdate&amp;friendly=1', '800', '600');\"><img src=\"imprimante.gif\" alt=\"imprimer\" border=\"0\"></a>\n";
}
