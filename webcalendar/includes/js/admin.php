...
function public_handler () {
  var enabled = document.prefform.admin_public_access[1].checked;
...
function eu_handler () {
  var enabled = document.prefform.admin_allow_external_users[1].checked;
...
function email_handler () {
  var enabled = document.prefform.admin_send_email[1].checked;
  //alert ( "allow external =  " + enabled );
  if ( enabled ) {
    // Email enabled
    makeVisible ( "em1" );
