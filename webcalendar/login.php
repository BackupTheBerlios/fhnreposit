...
//Inclut le init, pour avoir le bandeau
...
<?php echo '<link rel="stylesheet" type="text/css" href="includes/styles.php">'; ?>
<?php
...
<body onload="myOnLoad();" style="background-image:url(images_haras/fond_bandeau_ssbg.jpg);background-repeat:no-repeat;">
<?php
// Print custom header (since we do not call print_header function)
...
?>
  ...
  <div style="top:45px;left:400px;position:absolute;" id="menu">
  <div  class="accueil">
  Agenda partagé des Haras nationaux
  </div></div>

<div style="top:100px;left:200px;position:absolute;">
<?php
...
<table class="standard" style="border: 1px solid <?php echo $TABLEBG;?>;" cellpadding="10" width="400">
<tr><td rowspan="2">
...
<td colspan="2" align="middle">
  <input type="reset" value="Quitter" onclick="if (confirm('Désirez-vous réellement quitter l\'aganda partagé ?')) {self.close()}" tabindex="4" />
</td></tr>
</table>
</form>
</div>
...
<br />
<hr width="80%" /><br /><br />
Ce programme a été développé à partir du logiciel libre <a href="<?php echo $PROGRAM_URL ?>" class="aboutinfo">Webcalendar</a>
