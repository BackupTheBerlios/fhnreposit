...
if (isset($prech)) { // si param de recherche définis= C ou M
	// valeurs par défaut 
	...
	switch ($prech) {
		...
		case "M":
			$ss_prmev[title]="Mise à jour de structures externes";
			$ss_prmev[ro]="M";
			break;
		
		case "C" :
			$ss_prmev[title]="Consultation de structures externes";
			break;
...
?>
<form name="theform" action="list_soc.php" method="POST">
...
<input type="hidden" name="lc_FirstSoc" value="0">
